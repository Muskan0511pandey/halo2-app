...
use halo2_proofs::multicore::Worker;
// Worker implementation for wasm
...
#[cfg(target_arch = "wasm32")]
pub fn draw_circuit<F: Field>(_k: u32, _circuit: &HammsterCircuit<F>) {
    println!("Circuit drawing is not supported in WebAssembly");
}
